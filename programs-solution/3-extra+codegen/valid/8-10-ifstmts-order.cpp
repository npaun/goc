...
void __golite__main()
{
	if ((([&]() { int __golite_tmp_call__1 = ([&]() {  return __golite__foo(); })(); int __golite_tmp_call__2 = ([&]() {  return __golite__foo(); })();  return __golite__bar(__golite_tmp_call__1, __golite_tmp_call__2); })() == __golite__false))
	{
