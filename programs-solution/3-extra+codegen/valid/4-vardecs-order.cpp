...
int __golite__foo(int __golite__a, int __golite__b)
{
...
void __golite__main()
{
	int __golite_tmp_a__1 = ([&]() { int __golite_tmp_call__2 = ([&]() {  return __golite__bar(); })(); int __golite_tmp_call__3 = ([&]() {  return __golite__bar(); })();  return __golite__foo(__golite_tmp_call__2, __golite_tmp_call__3); })();
